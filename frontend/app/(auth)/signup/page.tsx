  ...
  return (
    <main className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-0 right-1/4 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl opacity-10">
          <div className="w-full h-full bg-coral-500 rounded-full" />
        </div>
        <div className="absolute bottom-1/4 left-0 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl opacity-10">
      ...
      <div className="w-full max-w-md animate-fadeInUp">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-2 text-sm">Powerful content at your fingertips</p>
        </div>
        ...
        <div className="card-glass border-cyan-400/20 p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-400">Create an account to start creating amazing content</p>
          </div>
